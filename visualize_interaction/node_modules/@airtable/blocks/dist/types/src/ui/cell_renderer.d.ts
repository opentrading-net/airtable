...
export declare class CellRenderer extends React.Component<CellRendererProps> {
    ...
    static propTypes: {
        ...
        renderInvalidCellValue: PropTypes.Requireable<(...args: any[]) => any>;
    };
    /** @hidden */
    static defaultProps: {
        shouldWrap: boolean;
...
declare const _default: React.RefForwardingComponent<CellRenderer, Pick<CellRendererProps, "left" | "right" | "top" | "bottom" | "style" | "flex" | "alignSelf" | "display" | "flexBasis" | "flexGrow" | "flexShrink" | "justifySelf" | "marginBottom" | "marginLeft" | "marginRight" | "marginTop" | "maxWidth" | "minWidth" | "order" | "position" | "width" | "zIndex" | "margin" | "field" | "record" | "cellValue" | "marginX" | "marginY" | "onMouseEnter" | "onMouseLeave" | "onClick" | "hasOnClick" | "shouldWrap" | "cellClassName" | "cellStyle" | "renderInvalidCellValue"> & React.RefAttributes<CellRenderer>>;
