...
declare const _default: React.RefForwardingComponent<ColorPalette, Pick<ColorPaletteProps, "disabled" | "style" | "color" | "onChange" | "className" | "onMouseEnter" | "onMouseLeave" | "onClick" | "hasOnClick" | "allowedColors" | "squareMargin"> & ColorPaletteStyleProps & React.RefAttributes<ColorPalette>>;
