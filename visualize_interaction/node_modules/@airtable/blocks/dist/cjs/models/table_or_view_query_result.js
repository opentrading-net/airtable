...
function (_RecordQueryResult) {
  ...
  (0, _createClass2.default)(TableOrViewQueryResult, null, [{
    ...
    value: function __createOrReuseQueryResult(sourceModel, recordStore, opts) {
      ...
      var normalizedOpts = _record_query_result.default._normalizeOpts(tableModel, recordStore, opts);
    ...
    key: "__createOrReuseQueryResultWithNormalizedOpts",
    value: function __createOrReuseQueryResultWithNormalizedOpts(sourceModel, normalizedOpts) {
  ...
  /** @internal */
  function TableOrViewQueryResult(sourceModel, normalizedOpts) {
    var _this;
  ...
  (0, _createClass2.default)(TableOrViewQueryResult, [{
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 4:
              ...
              for (_iterator6 = this._sorts[Symbol.iterator](); !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
                sort = _step6.value;
    ...
    get: function get() {
      ...
      (0, _error_utils.invariant)(this._data.recordIds, 'No recordIds');
