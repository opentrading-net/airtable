              ...
              for (var _iterator = records[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                ...
                for (var _i = 0, _Object$keys = Object.keys(record.cellValuesByFieldId); _i < _Object$keys.length; _i++) {
                  ...
                  if (existingRecord && recordStore.areCellValuesLoadedForFieldId(fieldId)) {
                    var validationResult = airtableInterface.fieldTypeProvider.validateCellValueForUpdate(appInterface, record.cellValuesByFieldId[fieldId], existingRecord._getRawCellValue(field), field._data);
        ...
        case _mutations.MutationTypes.CREATE_SINGLE_FIELD:
          {
            ...
            var _validationResult2 = airtableInterface.fieldTypeProvider.validateConfigForUpdate(appInterface, config, null, null, billingPlanGrouping);
        ...
        case _mutations.MutationTypes.UPDATE_SINGLE_FIELD_CONFIG:
          {
            ...
            var currentConfig = airtableInterface.fieldTypeProvider.getConfig(appInterface, _field2._data, _field2.parentTable.__getFieldNamesById());

            var _validationResult3 = airtableInterface.fieldTypeProvider.validateConfigForUpdate(appInterface, _config, currentConfig, _field2._data, billingPlanGrouping);
        ...
        case _mutations.MutationTypes.CREATE_SINGLE_TABLE:
          {
            ...
            try {
              for (var _iterator4 = fields[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                ...
                var _validationResult4 = airtableInterface.fieldTypeProvider.validateConfigForUpdate(appInterface, _field3.config, null, null, billingPlanGrouping);
            ...
            if (!airtableInterface.fieldTypeProvider.canBePrimary(appInterface, primaryField.config, billingPlanGrouping)) {
        ...
        case _mutations.MutationTypes.DELETE_MULTIPLE_RECORDS:
          {
            ...
            var _recordStore2 = this._base.__getRecordStore(_tableId5);
            ...
            return [...recordIds.map(recordId => ({
              path: ['tablesById', _tableId5, 'recordsById', recordId],
              value: undefined
            })), ...this._base.getTableById(_tableId5).views.flatMap(view => {
        ...
        case _mutations.MutationTypes.CREATE_MULTIPLE_RECORDS:
          {
            ...
            var _recordStore3 = this._base.__getRecordStore(_tableId6);
            ...
            return [..._records2.map(record => {
              ...
              return {
                path: ['tablesById', _tableId6, 'recordsById', record.id],
                value: {
                  id: record.id,
