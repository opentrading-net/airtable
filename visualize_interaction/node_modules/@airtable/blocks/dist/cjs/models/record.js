...
function (_AbstractModel) {
  ...
  (0, _createClass2.default)(Record, [{
    ...
    value: function getCellValue(fieldOrFieldIdOrFieldName) {
      ...
      var cellValue = this._getRawCellValue(field); // HACK: migrate to new public lookup cell value format if needed


      if (typeof cellValue === 'object' && cellValue !== null && field.type === _field.FieldType.MULTIPLE_LOOKUP_VALUES && !(0, _airtable_interface.default)().sdkInitData.isUsingNewLookupCellValueFormat) {
