...
var aggregate = (aggregatorKey, records, field) => {
  ...
  var _getSdk = (0, _get_sdk.default)(),
      appInterface = _getSdk.__appInterface,
      airtableInterface = _getSdk.__airtableInterface;
...
var aggregateToString = (aggregatorKey, records, field) => {
  ...
  var _getSdk2 = (0, _get_sdk.default)(),
      appInterface = _getSdk2.__appInterface,
      airtableInterface = _getSdk2.__airtableInterface;
...
function createAggregators() {
  var _getSdk3 = (0, _get_sdk.default)(),
      airtableInterface = _getSdk3.__airtableInterface;
